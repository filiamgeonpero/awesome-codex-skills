...
> **Personal note:** I keep my skills directory symlinked to a Dropbox folder so they sync across machines automatically:
> `ln -s ~/Dropbox/codex-skills ~/.codex/skills`
